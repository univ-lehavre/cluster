...
| 27  | GitOps → workflows atlas (push e2e) | **Push** des **workflows atlas** sur Gitea → **webhook** → Argo CD **Synced/Healthy** → run Dagster + **lineage Marquez** (infra DataOps déjà posée par Ansible) | ~5 min        | **Intégration** workflows atlas par GitOps (ADR 0044/0045, #231) — _à implémenter_ |
