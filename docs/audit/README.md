# Audit du dépôt `cluster`

> Audit réalisé le **2026-05-29**. Méthode : exécution réelle de la chaîne
> qualité (prettier, yamllint, shellcheck, ansible-lint, kubeconform, jscpd,
> gitleaks) + lecture en profondeur du code et de la documentation par une
> flotte d'agents d'analyse, chaque constat majeur étant **vérifié de façon
> adversariale** (un second relecteur tente de réfuter le constat avant qu'il ne
> soit retenu). Les gravités ci-dessous sont les gravités **après**
> vérification.
...
| Fichier                                          | Contenu                                                     |
| ------------------------------------------------ | ----------------------------------------------------------- |
| [README.md](README.md) _(ce fichier)_            | Synthèse exécutive, tableau de bord, plan d'action priorisé |
