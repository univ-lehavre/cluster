...
| [plan-ha-3cp-control-plane.md](plan-ha-3cp-control-plane.md)                                   | Plan              | HA control-plane 3 nœuds (promotion in-place, kube-vip) — ADR 0055 `Superseded`, topologie `ha-3cp` abandonnée (`Abandonné`)                                                                                                                    |
...
| [plan-refonte-nestor-python.md](plan-refonte-nestor-python.md)                                 | Plan              | Refonte nestor Python (graphe figé + moteur de chemin) — met en œuvre ADR 0096/0097                                                                                                                                                             |
| [plan-right-sizing-ressources.md](plan-right-sizing-ressources.md)                             | Plan vivant       | Right-sizing des limites mémoire du socle (Prometheus/Grafana/MLflow/Marquez) — met en œuvre ADR 0046 sur la dette chiffrée le 2026-07-04                                                                                                       |
| [plan-build-in-pod-preimage.md](plan-build-in-pod-preimage.md)                                 | Plan `Superseded` | Build de code in-pod sur pré-image — met en œuvre ADR 0110 (`Accepted`), **réécrit par [ADR 0112](../decisions/0112-cicd-in-cluster-gitea-actions-buildkit.md)** : build in-pod rétabli via **Gitea Actions** (pas la Sentinelle/Job planifiés) |
