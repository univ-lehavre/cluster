...
| [plan-build-in-pod-preimage.md](plan-build-in-pod-preimage.md)                                 | Plan        | Build de code in-pod sur pré-image (buildkitd rootless + Job + Sentinelle) — met en œuvre ADR 0110 (`Brouillon`)                          |
