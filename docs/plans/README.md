...
| [plan-refonte-nestor-python.md](plan-refonte-nestor-python.md)                                 | Plan        | Refonte nestor Python (graphe figé + moteur de chemin) — met en œuvre ADR 0096/0097, `Brouillon`                                    |
